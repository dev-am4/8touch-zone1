...
Visitor มี **8 จุดแตะเท่านั้น** และแต่ละจุดผูกกับเรื่องของตัวเองแบบ 1:1

- จุด 1 แตะ → เล่นเรื่องของจุด 1
- จุด 2 แตะ → เล่นเรื่องของจุด 2
- ระหว่างเล่น ถ้าแตะจุดอื่น → เปลี่ยนไปเล่นเรื่องของจุดนั้นทันที
- ถ้าแตะจุดเดิมซ้ำ → ยกเลิกเรื่องนั้นและกลับ Main
- ไม่มีปุ่ม Back เพิ่มเป็นจุดที่ 9
- ไม่มีพื้นที่แตะอวัยวะซ้ำอีกชุด

ตำแหน่งทั้ง 8 จุดอยู่ในช่วงเอื้อมที่ตั้งใจไว้สำหรับผู้ชมหลายช่วงวัย และปรับด้วย F7 ตอนติดตั้งจริง
...
- ระหว่าง Story ทั้ง 8 จุดยังทำงานต่อเนื่องเพื่อเลือกเรื่องอื่น
...
## Eight-point interaction contract

มี visitor input เพียง 8 จุด และแต่ละจุดควบคุมคลิปของตัวเอง:
